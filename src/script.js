...
const planetColorTexture = textureLoader.load("/textures/1/1_color.jpg")
const planetDispTexture = textureLoader.load("/textures/1/1_disp.png")
const planetNormalTexture = textureLoader.load("/textures/1/1_normal.jpg")
const planetOccTexture = textureLoader.load("/textures/1/1_occ.jpg")
const planetRoughnessTexture = textureLoader.load('/textures/door/rough.jpg')
...
planetMaterial.displacementMap = planetDispTexture
